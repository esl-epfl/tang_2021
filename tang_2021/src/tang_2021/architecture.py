...
class DCRNNModel_classification(nn.Module):
    ...
    def forward(self, input_seq, seq_lengths, supports):
        ...
        last_out = tang2021_utils.last_relevant_pytorch(
...
class DCRNNModel_nextTimePred(nn.Module):
    ...
    def forward(
        ...
        """
        batch_size, output_seq_len, num_nodes = decoder_inputs.shape # [Samanos] changed: expected 4 dimensions, got 3
        ...
        if self.training and self.use_curriculum_learning and (
            ...
            teacher_forcing_ratio = tang2021_utils.compute_sampling_threshold(
